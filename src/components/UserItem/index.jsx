  ...
  return (
    <li className={styles.user}>
      <ul className={styles.userList}>
        <li className={styles.userList__item}>#{id}</li>
        <li className={styles.userList__item}>{name}</li>
        <li className={styles.userList__item}>{passport}</li>
        <li className={styles.userList__item}>{phone}</li>
        <li className={styles.userList__item}>{vin}</li>
        <li className={styles.userList__item}>{car}</li>
        <li className={styles.userList__item}>{car_color}</li>
        <li className={styles.userList__item}>{car_number}</li>
        <li className={styles.userList__edit}>
          <div className={styles.userList__editIcon}>
            <svg
              width="21"
              height="22"
              viewBox="0 0 21 22"
